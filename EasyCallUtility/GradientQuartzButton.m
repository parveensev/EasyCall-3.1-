...
#import "GradientQuartzButton.h"

@interface GradientQuartzButton()
...
@implementation GradientQuartzButton
...
- (void)useEasyCallBlueStyle
{
    NSMutableArray *colors = [NSMutableArray arrayWithCapacity:3];
    UIColor *color = [UIColor colorWithRed:0.612 green:0.878 blue:0.925 alpha:1.0];
    [colors addObject:(id)[color CGColor]];
    color = [UIColor colorWithRed:0.573 green:0.867 blue:0.910 alpha:1.0];
    [colors addObject:(id)[color CGColor]];
    color = [UIColor colorWithRed:0.529 green:0.847 blue:0.898 alpha:1.0];
    [colors addObject:(id)[color CGColor]];
    ...
    color = [UIColor colorWithRed:0.263 green:0.737 blue:0.820 alpha:1.0];
    [colors2 addObject:(id)[color CGColor]];
    color = [UIColor colorWithRed:0.200 green:0.706 blue:0.796 alpha:1.0];
    [colors2 addObject:(id)[color CGColor]];
...
- (void)useNurseBlueStyle
{
    ...
    color = [UIColor colorWithRed:0.200 green:0.706 blue:0.796 alpha:1.0];
    [colors2 addObject:(id)[color CGColor]];
    color = [UIColor colorWithRed:0.200 green:0.710 blue:0.800 alpha:1.0];
    [colors2 addObject:(id)[color CGColor]];
    color = [UIColor colorWithRed:0.200 green:0.710 blue:0.800 alpha:1.0];
    [colors addObject:(id)[color CGColor]];
